...
public class BankContext : IdentityDbContext<UserModel, IdentityRole<int>, int> {
    ...
    public DbSet<BannerModel> Banners { get; set; } = null!;
    public DbSet<BannerPlacementModel> BannerPlacements { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity<ClientModel>()
            ...
            .HasMaxLength(255);
        modelBuilder.Entity<ClientModel>()
            .Property(c => c.ClientCity)
            .HasColumnName("client_city")
            .IsRequired()
            .HasMaxLength(100);
        modelBuilder.Entity<ClientModel>()
            .Property(c => c.ClientState)
            .HasColumnName("client_state")
            .IsRequired()
            .HasMaxLength(50);
        modelBuilder.Entity<ClientModel>()
            .Property(c => c.ClientCep)
        ...
        modelBuilder.Entity<AddressModel>()
            .ToTable("Address");
        modelBuilder.Entity<AddressModel>()
            .HasKey(a => a.AddressId); // ESTA LINHA É O QUE ESTÁ FALTANDO
        modelBuilder.Entity<AddressModel>()
        ...
        modelBuilder.Entity<AddressModel>()
            ...
            .HasMaxLength(50);
        modelBuilder.Entity<AddressModel>()
            .Property(a => a.AddressNeighborhood)
            .HasColumnName("address_neighborhood");
        modelBuilder.Entity<AddressModel>()
            .Property(a => a.AddressCity)
            .HasColumnName("address_city")
            .IsRequired()
            .HasMaxLength(100);
        modelBuilder.Entity<AddressModel>()
            .Property(a => a.AddressState)
            .HasColumnName("address_state")
            .IsRequired()
            .HasMaxLength(50);
        modelBuilder.Entity<AddressModel>()
            .Property(a => a.AddressCep)
        ...
        // No seu BankContext.cs, dentro do método OnModelCreating

// --- CONFIGURAÇÃO PARA A ENTIDADE Banners ---
        modelBuilder.Entity<BannerModel>(
            entity => {
                ...
                // Configura cada propriedade para mapear para a coluna correta
                entity.Property(b => b.BannerId)
                    .HasColumnName("banner_id")
                    .ValueGeneratedOnAdd(); // Equivalente ao IDENTITY(1,1)
                ...
                entity.Property(b => b.IsActive)
                    ...
                    .IsRequired()
                    .HasDefaultValue(true); // Equivalente ao DEFAULT 1
            }
        );


// --- CONFIGURAÇÃO PARA A ENTIDADE BannersPlacements ---
        modelBuilder.Entity<BannerPlacementModel>(
            entity => {
                entity.ToTable("BannersPlacements");

                entity.HasKey(bp => bp.BannerPlacementId);

                entity.Property(bp => bp.BannerPlacementId)
                    .HasColumnName("banner_placement_id")
                    .ValueGeneratedOnAdd();

                entity.Property(bp => bp.PageName)
                    .HasColumnName("banner_placement_pagename")
                    .IsRequired()
                    .HasMaxLength(50);

                entity.Property(bp => bp.DisplayOrder)
                ...
                entity.Property(bp => bp.BannerId)
                    .HasColumnName("banner_id")
                    .IsRequired();

                // --- CONFIGURAÇÃO DO RELACIONAMENTO (CHAVE ESTRANGEIRA) ---
                entity.HasOne(placement => placement.Banner) // Um "Placement" tem um "Banner"
                    .WithMany(banner => banner.Placements) // Um "Banner" tem muitos "Placements"
                    .HasForeignKey(placement => placement.BannerId) // A chave estrangeira é BannerId
                    .HasConstraintName("FK_BannerPlacements_Banners") // Garante o mesmo nome da sua constraint
                    .OnDelete(DeleteBehavior.Cascade); // Garante o mesmo comportamento ON DELETE CASCADE
            }
        );
    }
}